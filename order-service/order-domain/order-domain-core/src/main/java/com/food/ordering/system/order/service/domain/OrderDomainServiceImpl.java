...
public class OrderDomainServiceImpl implements OrderDomainService {
    ...
    private final static String ZONE_ID = "UTC";
    ...
    private void setOrderProductInformation(Order order, Restaurant restaurant) {
        ...
        restaurant.getProducts().forEach(restaurantProduct -> restaurantProductMap.put(restaurantProduct.getId(), restaurantProduct));
    ...
    private void validateRestaurant(Restaurant restaurant) {
        if (!restaurant.isActive()) {
            throw new RuntimeException("Restaurant with id " + restaurant.getId().getValue() + " is not active");
        }
    }
